                                ...
                                sshPublisherDesc(
                                    ...
                                    transfers: [
                                        sshTransfer(
                                            ...
                                            execCommand: "docker-compose -f restaurant/docker-compose.yml stop; docker rmi arifh19/restaurant-frontend; docker-compose up -f restaurant/docker-compose.yml -d",
                                            execTimeout: 120000,
                                        ),
                                    ]
                                ),
