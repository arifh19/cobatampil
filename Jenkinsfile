                                ...
                                sshPublisherDesc(
                                    ...
                                    transfers: [
                                        sshTransfer(
                                            ...
                                            execCommand: "docker-compose -f restaurant/docker-compose.yml stop; docker rm arifh19/restaurant_frontend_1; docker rmi arifh19/restaurant-frontend; docker-compose up -f restaurant/docker-compose.yml -d",
                                            execTimeout: 120000,
                                        ),
                                    ]
                                ),
